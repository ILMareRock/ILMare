...
public class Utils {
  ...
  public static void parseServiceData(String deviceAddress, byte[] serviceData, Beacon beacon) {
    if (serviceData == null) {
      String err = "Null Eddystone service data";
      beacon.frameStatus.nullServiceData = err;
        Log.e("ServiceData is Null!!", deviceAddress + ", err=" + err);
      return;
    }
    switch (serviceData[0]) {
      ...
      default:
        ...
        beacon.frameStatus.invalidFrameType = err;
          Log.e("ParseServiceDataError!!", deviceAddress + ", err=" + err);
        break;
    }
  }
